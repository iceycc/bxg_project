...
- 目标
  - 充分了解后台登录接口的业务登录过程
    - sessionID会通过set-cookie保存到浏览器中
    - 浏览器关闭以后session和sessionID失效
  - 能够利用sessionStorage保存登录以后的用户数据到浏览器内存中
  - 学会antd中的表单组件使用 https://ant.design/components/form-cn/
...
- antd Form表单使用文档：https://ant.design/components/form-cn/
...
- 学习getInitialProps方法的作用



## detail.js基本结构-获取传入的query参数
...
- 进入此页面需要登录验证
  ...
  - 登录检查api文档：http://157.122.54.189:9092/upload/preview/siteapi.html#203
...
- 章节明细数据API：http://157.122.54.189:9092/upload/preview/siteapi.html#503

- 课程大纲数据API：http://157.122.54.189:9092/upload/preview/siteapi.html#502
...
- antd分页组件：https://ant.design/components/pagination-cn/
